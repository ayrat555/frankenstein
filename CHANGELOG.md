...
- refactor!: merge Error and HttpError by @EdJoPaTo in https://github.com/ayrat555/frankenstein/pull/204
- refactor: improve generic argument naming by @EdJoPaTo in https://github.com/ayrat555/frankenstein/pull/205
- refactor(json)!: generalize encoding/decoding by @EdJoPaTo in https://github.com/ayrat555/frankenstein/pull/206
- Migrate from `typed-builder` to `bon` by @Veetaha in https://github.com/ayrat555/frankenstein/pull/196
