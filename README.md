...
```toml
[dependencies]
frankenstein = { version = "0.44", features = [] }
```
...
```toml
frankenstein = { version = "0.44", features = ["client-reqwest"] }
```
